                        ...
                        <div class="row">
                            <div class="py-0 mb-5 col-12 mb-sm-5 mb-md-5 mb-xl-0 col-md-12 col-xl-6 form-input-section">
                                ...
                                <div class="shadow card h-100">
                                    <div class="p-4 py-0 text-sm card-body p-md-7 py-md-7">
                                        ...
                                        <form @submit.prevent="updateExpense" enctype="multipart/form-data">
                                            <div class="mt-3 row">
                                                ...
                                                <div class="pt-2 col-md-9">
                                                    <input v-model="edit_expense.code" type="cost"
                                            ...
                                            <div class="mt-3 row">
                                                <div class="col-md-3">
                                                    <div class="text-gray-600 col-form-label">Category <i
                                                            class="cursor-pointer bi bi-plus-lg-fill fs-5 plus-btn"
                                                            data-toggle="tooltip" data-placement="bottom"
                                                            title="Add new category"
                                                            v-if="edit_expense.deleted_at == null && (page_props.auth.user.user_role_id == 1 || page_props.auth.user.user_role_id == 4)"
                                                            @click.prevent="showExpenseCategoryModal"></i></div>
                                                </div>
                                                <div class="pt-2 col-md-9">
                                                    <Multiselect v-model="edit_select_category" :options="categories"
                                                        ...
                                                        :disabled="edit_expense.deleted_at != null || (page_props.auth.user.user_role_id != 1 && page_props.auth.user.user_role_id != 4)" />
                                            ...
                                            <div class="mt-3 row">
                                                <div class="col-md-3">
                                                    <div class="text-gray-600 col-form-label">Supplier <i
                                                            class="ml-4 cursor-pointer bi bi-plus-lg-fill fs-5 plus-btn-supplier"
                                                            data-toggle="tooltip" data-placement="bottom"
                                                            title="Add new supplier"
                                                            v-if="edit_expense.deleted_at == null && (page_props.auth.user.user_role_id == 1 || page_props.auth.user.user_role_id == 4)"
                                                            @click.prevent="showSupplierModal"></i></div>
                                                </div>
                                                <div class="pt-2 col-md-9 d-flex multiselect-wrapper">
                                                    <Multiselect v-model="edit_select_supplier" :options="suppliersSearch.map(supplier => ({
                                                        ...supplier,
                                                    ...
                                                    }))" class="z__index remove-column" :showLabels="false"
                                                        :close-on-select="true" :clear-on-select="false"
                                                        :searchable="true" placeholder="Select Supplier"
                                                        label="searchableText" track-by="id" max-height="200"
                                                        :disabled="edit_expense.deleted_at != null || (page_props.auth.user.user_role_id != 1 && page_props.auth.user.user_role_id != 4)"
                                                        @search-change="getSuppliersSearch" :internal-search="false">
                                                        <template #noOptions>
                                                    ...
                                                    <button
                                                        v-if="edit_expense.supplier_id != null && (page_props.auth.user.user_role_id == 1 || page_props.auth.user.user_role_id == 4)"
                                            ...
                                            <div class="mt-3 row">
                                                ...
                                                <div class="pt-2 col-md-9">
                                                    <input v-model="edit_expense.amount" type="cost"
                                            ...
                                            <div class="mt-3 row">
                                                ...
                                                <div class="pt-2 col-md-9">
                                                    <input v-model="edit_expense.remark" type="cost"
                                            ...
                                            <div class="mt-3 row">
                                                ...
                                                <div class="pt-2 col-md-9">
                                                    <textarea v-model="edit_expense.description" class="form-control"
                                                        ...
                                                        :disabled="edit_expense.deleted_at != null || (page_props.auth.user.user_role_id != 1 && page_props.auth.user.user_role_id != 4)"></textarea>
                                            ...
                                            <div class="row d-none d-md-flex"
                                                ...
                                                <div class="col-12 text-end align-items-end action-btn-margin">
                                                    <button type="button" class="btn btn-primary ms-2 fw-bold"
                                                        data-toggle="tooltip" data-placement="bottom"
                                                        title="Print voucher"
                                                        @click.prevent="expensePrint(edit_expense.id)">
                                                        PRINT
                                                    </button>
                                                    ...
                                                    <button type="button" class="btn btn-warning ms-2 fw-bold"
                                                        data-toggle="tooltip" data-placement="bottom"
                                                        title="Email expense" @click.prevent="showCustomerEmailModal">
                                                        EMAIL
                                                    </button>
                                                    <button type="button" class="btn btn-danger ms-2 fw-bold"
                                                        data-toggle="tooltip" data-placement="bottom"
                                                        title="Delete expense" @click="deleteExpense(edit_expense.id)">
                                                        DELETE
                                                    </button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row" v-else>
                                                <div
                                                    class="mb-4 col-12 text-end align-items-end w-100 action-btn-margin mb-md-0">
                                                    <button type="button" class="btn btn-warning" data-toggle="tooltip"
                                                        data-placement="bottom" title="Restore expense"
                                                        v-if="(page_props.auth.user.user_role_id == 1 || page_props.auth.user.user_role_id == 4)"
                                                        @click.prevent="restoreExpense(edit_expense.id)"
                            ...
                            <div class="py-0 col-12 col-md-12 col-xl-6">
                                <div class="shadow card h-100">
                                    <div class="p-4 py-0 text-sm card-body p-md-7 py-md-3">
                                        ...
                                        <form @submit.prevent="updateExpense" enctype="multipart/form-data">
                                            <div class="mt-3 row">
                                                ...
                                                <div class="pt-2 col-md-12 d-flex justify-content-center">
                                                    ...
                                                    <div class="p-2 image-input image-chooser-border d-none d-md-flex"
                                                        ...
                                                        <div class="image-input-wrapper w-400px h-400px">
                                                            <template v-if="edit_expense.isPdf == 1">
                                                                <iframe :src="edit_expense.image_url" width="100%"
                                                                    height="400px"></iframe>
                                                            </template>
                                                            <!-- Otherwise, show an image -->
                                                            <template v-else>
                                                                <img v-if="edit_expense.image_url && edit_expense.isPdf == 0"
                                                                    :src="edit_expense.image_url"
                                                        ...
                                                        <div class="py-2 dropdown-menu menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold fs-6 w-175px"
                                                            ...
                                                            <a v-if="edit_expense.image_url && edit_expense.isPdf == 0"
                                                                class="px-5 py-2 cursor-pointer menu-item"
                                                                @click="downloadImageFile(edit_expense.image_url)">
                                                        ...
                                                        <input type="file" ref="fileInput"
                                                            v-if="edit_expense.deleted_at == null"
                                                            accept="image/jpg, image/png, application/pdf"
                                                            id="expense_image" name="avatar" hidden
                                                            @change="onFileChangeEdit">
                                                        <input type="hidden" name="avatar_remove">

                                                        <span
                                                            v-if="edit_expense.image_url && edit_expense.deleted_at == null"
                                                        ...
                                                        <div class="py-2 dropdown-menu menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold fs-6 w-175px"
                                                            data-kt-menu="true" id="edit-toggle-box">
                                                            <a v-if="edit_expense.image_url && edit_expense.isPdf == 1"
                                                                class="px-5 py-2 cursor-pointer menu-item"
                                                                @click="downloadReceipt(edit_expense.image_url)">
                                                                <i class="text-gray-700 bi bi-download"></i> <span
                                                                    class="text-gray-700 ms-2">Download
                                                                    File</span>
                                                            </a>
                                                            ...
                                                            <div v-if="edit_expense.image_url && edit_expense.isPdf == 1 && (page_props.auth.user.user_role_id == 1 || page_props.auth.user.user_role_id == 4)"
                                                            ...
                                                            <div v-if="edit_expense.image_url && edit_expense.isPdf == 0 && (page_props.auth.user.user_role_id == 1 || page_props.auth.user.user_role_id == 4)"
                                                                class="px-5 py-3 mt-1 cursor-pointer menu-item border-top"
                                                                @click="openEditImageFile">
                                                                <i class="text-gray-700 bi bi-image-fill"></i> <span
                                                                    class="text-gray-700 ms-2">Change
                                                ...
                                                <div v-if="edit_expense.image_url == null"
                                                    class="pt-4 text-center text-gray-400 col-12">
                                            ...
                                            <div class="mt-10 row">
                                                <div class="mt-4 col text-end">
                                                    ...
                                                    <!-- <a v-if="edit_expense.image_url && edit_expense.isPdf == 1"
                                                        :href="edit_expense.image_url" target="_blank"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-light-danger" style="font-weight: bold"
                                data-toggle="tooltip" data-placement="bottom" title="Delete receipt"
                                    ...
                                    <div class="mb-4 col-12" :class="[phoneIndex <= 1 ? 'd-none' : '',]">
                                        ...
                                        <div class="row">
                                            <div class="mt-2 mb-2 col-12" :class="[phoneIndex !== 2 ? 'd-none' : '',]">
                                                <a href="javascript:void(0)" class="text-primary" data-toggle="tooltip"
                                                    data-placement="bottom" title="Add anther phone number"
                                                    @click="phoneIndex = 3">+
                                                    Another
                                                    Phone No.</a>
                                            </div>
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="pb-4 pl-4 pr-4 modal-content">
                        <div class="pb-5 modal-body px-sm-5 mx-50">
                            <div class="row">
                                <div class="mb-5 col-8">
                                    <h1 class="modal-title" style="color: #071437">Send Expenses</h1>
                                </div>
                                <div class="mb-5 col-4 text-end">
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                                        data-toggle="tooltip" data-placement="bottom" title="Close"></button>
                            ...
                            <form id="addNewCardValidation" class="row gy-1 gx-2 mt-75"
                                @submit.prevent="sendExpenseEmail()">
                                ...
                                <div class="mt-4 text-right col-12">
                                    ...
                                    <button type="submit" class="mt-1 btn btn-info fw-bold" data-toggle="tooltip"
                                        data-placement="bottom" title="Send expense email">
...
const handleFileDrop = (e) => {
    if (page_props.auth.user.user_role_id != 3) {
        ...
        if (file && file.size < 5 * 1024 * 1024) {
            edit_expense.value.image = file;
            edit_expense_image.value = file;
            updateExpense();
            const reader = new FileReader();
            reader.onload = (event) => {
                edit_expense.value.image_url = event.target.result;
            };
            reader.readAsDataURL(file);
        } else {
...
const removeSupplier = async () => {
    try {
        const response = await axios.delete(route('expenses.supplier.delete', edit_expense.value.id));
        successMessage('Supplier removed successfully!');
        edit_select_supplier.value = [];
        getExpense();
...
const getExpense = async () => {
    try {
        ...
        if (edit_expense.value.supplier_id) {
            const supplier = (await axios.get(route('supplier.expense.get', edit_expense.value.supplier_id))).data;
            edit_select_supplier.value = [{
                ...supplier,
                company: truncateSupplierText(supplier.company),
                searchableText: supplier.company ? `${supplier.name} - ${truncateSupplierText(supplier.company)}` : supplier.name
        ...
        if (edit_expense.value.date) {
            const createdDate = new Date(edit_expense.value.date);
        ...
        if (edit_expense.value.deleted_at == null) {
    ...
    try {
        ...
        if (fileInputs.files[0]) {
            ...
            if (file.size > 5 * 1024 * 1024) {
                ...
                edit_expense_image.value = edit_expense_image.value;
        ...
        if (edit_date.value != null) {
            edit_expense.value.date = edit_date.value;
        }
...
const removeImage = async (id) => {
    ...
    try {
        ...
        await axios.get(route("expense.image.remove", id)).then((response) => {
            loadData(id);
...
const downloadReceipt = async (imagePath) => {
    ...
    try {
        const response = await axios.get(route('expense.downloadReceipt'), {
            responseType: 'blob',
            params: {
                imagePath: imagePath,
            }
        ...
        link.href = url;
        link.setAttribute('download', edit_expense.value.code + '-expense.pdf');
...
const downloadImageFile = async (imagePath) => {
    ...
    try {
        ...
        const link = document.createElement('a');
        link.href = url;
        link.setAttribute('download', edit_expense.value.code + '-expense.jpg');
...
const saveNewSupplier = async () => {
    ...
    try {
        ...
        if (response.data == "This contact number already registered") {
            ...
            edit_select_supplier.value = edit_select_supplier.value[0];
        }
...
const openEditImageFile = async () => {
    ...
    if (page_props.auth.user.user_role_id == 1 || page_props.auth.user.user_role_id == 4) {
        if (edit_select_category.value.id == null) {
            errorMessage('Please select an expense category');
        } else if (edit_expense.value.amount == null) {
            errorMessage('Please enter expense amount');
        } else {
            const fileInput = document.getElementById('expense_image');
            fileInput.click();
            fileInput.addEventListener('change', updateExpense);
        }
    }
...
const setSupplierEmailDetails = async (selectedSupplierData) => {
    try {
        ...
        supplier_email.value.subject = "Voucher Number : " + edit_expense.value.code;

        supplier_email.value.message =
            "<p>Hi " + selectedSupplierData.value.name +
            ",</p><p>I hope you’re doing well! Please see the attached voucher number " +
            edit_expense.value.code +
...
const sendExpenseEmail = async () => {
    ...
    try {
        ...
        const response = await axios.post(route("expenses.mail.send", edit_expense.value.id), supplier_email.value);
