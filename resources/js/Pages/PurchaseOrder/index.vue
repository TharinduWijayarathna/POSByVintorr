                            ...
                            <form action="" id="kt_invoice_form">
                                ...
                                <div class="mb-0">
                                    ...
                                    <div class="mb-5 row gx-10">
                                        ...
                                        <div class="col-lg-6">
                                            <label class="mb-3 text-gray-700 form-label fs-6 fw-bold">Purchase Order To
                                                <i v-if="purchaseOrder.deleted_at == null" data-toggle="tooltip"
                                            ...
                                            <div class="mb-2 d-flex position-relative">
                                                <Multiselect v-model="select_supplier" :options="suppliersSearch"
                                                    ...
                                                    placeholder="Select Supplier" label="name" track-by="id"
                                                ...
                                                <a v-if="po_supplier.supplier_id && orderProducts.length == 0" href="#"
                                                    data-toggle="tooltip" data-placement="bottom"
                                        ...
                                        <div class="text-right col-lg-3">
                                            ...
                                            <div class="row">
                                                <div v-for="purchaseOrder_parameter in purchaseOrder_parameters"
                                                    class="mt-2 col-12">
                                                    <div class="label-container">
                                                        <label class="text-gray-700 form-label fw-bold fs-6">{{
                                                            purchaseOrder_parameter.name }}</label>
                                                        <a href="javascript:void(0)" class="active-color-primary"
                                                            @click="getCustomField(purchaseOrder_parameter.id)">
                                                    ...
                                                    <input type="text"
                                                        class="form-control form-control-solid form-control-sm"
                                                        v-model="purchaseOrder_parameter.description"
                                                        :placeholder="purchaseOrder_parameter.name"
                                                        @keyup="saveParameterDescription(purchaseOrder_parameter.id, purchaseOrder_parameter)">
                                                </div>
                                                <div class="mt-4 col-12">
                                                    <a href="javascript:void(0)"
                                                        class="active-color-primary add-new-text-format"
                                                        data-toggle="tooltip" data-placement="bottom"
                                                        title="Add new customer filed" @click="openNewParameterModel">
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <textarea v-model="note" name="notes" class="form-control form-control-solid"
                                            @input="onTextNoteChange" rows="3" placeholder="Note"
                                            :disabled="purchaseOrder.deleted_at != null || purchaseOrder.credit_status == 1 || page_props.auth.user.user_role_id != 1"
                                            style="resize: none">
    </textarea>
                                    ...
                                    <div class="mt-3 purchaseOrder-footer-parameter">
                                        <div v-for="(purchaseOrder_footer_parameter, index) in purchaseOrder_footer_parameters"
                                            :key="purchaseOrder_footer_parameter.id" class="pt-8 col-12">
                                            <label class="text-gray-700 form-label fw-bold fs-6">
                                                <a href="javascript:void(0)" class="active-color-primary"
                                                    @click="getFooterCustomField(purchaseOrder_footer_parameter.id)">
                                                    <i data-toggle="tooltip" data-placement="bottom"
                                                        title="Edit footer custom filed"
                                                        class="bi bi-three-dots-vertical add-new-text-format"></i>
                                                </a>
                                                {{ purchaseOrder_footer_parameter.name }}
                                            </label>
                                            <textarea v-model="purchaseOrder_footer_parameter.description"
                                                class="form-control form-control-solid" :rows="3" placeholder="Note"
                                                style="resize: none;"
                                                :disabled="purchaseOrder.deleted_at != null || purchaseOrder.credit_status == 1 || page_props.auth.user.user_role_id != 1"
                                                @input="onFooterDescriptionChange(purchaseOrder_footer_parameter.id, purchaseOrder_footer_parameter.description)">
        </textarea>
                                        </div>
                                        <div class="pt-4 mt-4 col-12">
                                            <a href="javascript:void(0)"
                                                class="active-color-primary add-new-text-format" data-toggle="tooltip"
                                                data-placement="bottom" title="Add new customer filed"
                            ...
                            <div v-if="orderProducts.length > 0" class="mt-5 mb-0">
                                <div class="mb-5 row" v-if="purchaseOrder.deleted_at == null">
                                    <div class="col-4 pe-0">
                                        <a href="javascript:void(0)" @click.prevent="deletePurchaseOrder()"
                                    ...
                                    <div class="col-4">
                                        <a href="javascript:void(0)" class="btn w-100 btn-warning" data-toggle="tooltip"
                                            data-placement="bottom" title="Email Purchase Order"
                                            @click.prevent="showSupplierEmailModal">EMAIL</a>
                                    </div>
                                    <div class="col-4 ps-0">
                                        <a href="javascript:void(0)" @click.prevent="historyPrint()"
                                            data-toggle="tooltip" data-placement="bottom" title="Print Purchase Order"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form enctype="multipart/form-data">
                                ...
                                <div v-if="po_supplier.name != null">
                                    <div class="mt-2 row">
                                        <div class="mt-2 col-md-4">
                                    ...
                                    <div class="mt-3 row">
                                        <div class="col-12 justify-content-end text-end">
                                            <a class="square-clear-button" @click.prevent="saveSupplier(po_supplier)">
                                    ...
                                    <div class="mt-3 row">
                                        <div class="col-12 justify-content-end text-end">
                                            <a type="button" class="square-clear-button" data-toggle="tooltip"
                                                data-placement="bottom" title="Save new supplier"
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <form @submit.prevent="selectPurchaseOrderItemUpdate" enctype="multipart/form-data">
                                ...
                                <div class="text-gray-600 col-form-label">Cost</div>
                                <div class="row">
                                    <div class="col-12">
                                        <input v-model="edit_select_item.cost" type="text"
                                            class="form-control form-control-sm" placeholder="Cost" />
                                    </div>
                                </div>
                                <div class="mt-5 row">
                                    ...
                                    <div class="text-center col-6">
                                        <button type="button" @click.prevent="removeItem"
                                            class="btn btn-light-danger w-100 fw-bold" data-toggle="tooltip"
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    <div class="mt-4 col-12 text-end">
                                        <button type="submit" class="btn btn-info fw-bold" data-toggle="tooltip"
                                            data-placement="bottom" title="Add new supplier">
                                            ADD
                                        </button>
                                    </div>
                        ...
                        <div class="modal-body">
                            ...
                            <form @submit.prevent="saveProduct" enctype="multipart/form-data">
                                ...
                                <Multiselect v-if="is_stockable == true" v-model="select_unit" :options="units"
                                    ...
                                    title="Select product unit" :close-on-select="true" :clear-on-select="false"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form @submit.prevent="saveFooterParameter" enctype="multipart/form-data">
                            ...
                            <div class="modal-footer">
                                <button type="submit" class="mt-2 btn btn-info me-2 fw-bold" data-toggle="tooltip"
                                    data-placement="bottom" title="Add new footer custom field">
                                    ADD
                                </button>
                            </div>
                        </form>
            ...
            <div class="modal fade" id="editFooterParameterModal" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form @submit.prevent="updateFooterParameter(purchaseOrder_footer_parameter_field.id)"
            ...
            <div class="modal fade" id="editParameterModal" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form @submit.prevent="updateParameter(purchaseOrder_parameter_field.id)"
                            enctype="multipart/form-data">
                            <div class="modal-body">
                                <div class="text-gray-600 col-form-label">Custom Field Title</div>
                            ...
                            <form id="addNewCardValidation" class="row gy-1 gx-2 mt-75"
                                ...
                                <div class="mt-4 text-right col-12">
                                    ...
                                    <button type="submit" class="mt-1 btn btn-info fw-bold" data-toggle="tooltip"
                                        data-placement="bottom" title="Send Purchase Order">
...
const purchaseOrder_footer_parameters = ref({});
const parameter_footer_title = ref({});
const purchaseOrder_footer_parameter_field = ref({});
const parameter_footer_field = ref('');

const purchaseOrder_parameters = ref({});
const parameter_title = ref({});
const purchaseOrder_parameter_field = ref({});
...
const historyPrint = async () => {
    ...
    try {
        if (select_supplier.value) {
            const print = await axios.get(route('purchaseOrder.print', purchaseOrder.value.id), { responseType: "blob" });
...
const convertToInvoice = async () => {
    ...
    try {
        const response = (await axios.get(route("purchaseOrder.convert", purchaseOrder.value.id))).data;
...
const storeRef = async () => {
    ...
    try {
        ...
        if (ref_no.value.length > 120) {
            ...
            await axios.post(route('store.purchaseOrder.ref'), ref_data).data;
        }


    } catch (errors) {
        convertValidationNotification(errors);
    }
};
...
const addToPurchaseOrder = async () => {
    ...
    try {
        ...
        if (select_supplier.value) {
            ...
            const productData = (await axios.post(route('purchaseOrder.product.add'), selected_product.value)).data;
...
const getOderProduct = async () => {
    ...
    try {
        const orderProductData = (await axios.get(route('purchaseOrder.get.products'))).data;
...
const getPurchaseOrder = async () => {
    try {
        const invoiceData = (await axios.get(route('purchaseOrder.get'))).data;
        purchaseOrder.value = invoiceData;
        ...
        if (select_supplier.value != null) {
            po_supplier.value = purchaseOrder.value;
        }
        ...
        if (purchaseOrder.value.supplier_id != null) {
            select_search_supplier.value = purchaseOrder.value.supplier;
            // select_search_supplier.value.name = purchaseOrder.value.supplier_name;
...
const calculateTotals = async () => {
    ...
    try {
        const order = (await axios.get(route('purchaseOrder.getSubtotal.order'))).data;
...
const setOrderProductValue = async (product_id) => {
    try {
        const response = (await axios.get(route("purchaseOrder.product.get", product_id))).data;
...
const selectItemUpdate = async () => {
    ...
    try {
        ...
        if (selected_product.value.formatted_cost) {
            selected_product.value.cost = parseFloat(selected_product.value.formatted_cost.replace(/,/g, ''));
        }
...
const selectPurchaseOrderItemUpdate = async () => {
    ...
    try {
        ...
        if (edit_select_item.value.quantity <= 0) {
            ...
            await axios.post(route("purchaseOrder.product.qty", edit_product.value.id), edit_select_item.value);
...
const removeItem = async () => {
    ...
    try {
        ...
        (await axios.get(route('purchaseOrder.remove.product', edit_product.value.id))).data;
...
const setPurchaseOrderSupplier = async () => {
    ...
    try {
        ...
        await axios.get(route('purchaseOrder.supplier.store', supplier_id.value)).then((response) => {
            getPurchaseOrder();
            calculateTotals();
        });
...
const editPurchaseOrderSupplierDetails = async () => {
    ...
    try {
        ...
        await axios.post(route('change.purchaseOrder.supplier'), po_supplier.value);
...
const setPurchaseOrderCurrency = async () => {
    ...
    try {
        ...
        const tableData = (
            await axios.get(
                route('purchaseOrder.currency.store', currency_id.value)
            )
        ).data;
        calculateTotals();
        getPurchaseOrder();
...
const setPurchaseOrderNote = async () => {
    try {
        ...
        axios.post(route('purchaseOrder.note.save'), requestData).then((response) => {
        });
...
const paymentDone = async () => {
    ...
    try {
        ...
        if (changeAmount.value < 0 && selectSupplier.value == null) {
            errorMessage('Please select the supplier for credit invoice');
        ...
        } else if (changeAmount.value < 0 && selectSupplier.value != null) {
            const paidAmountInput = document.getElementById("paidAmount");
...
const setPurchaseOrderDate = async () => {
    ...
    try {
        ...
        axios.post(route('purchaseOrder.date.store'), data).then((response) => {
        });
...
const getFooterCustomField = async (id) => {
    ...
    try {
        ...
        purchaseOrder_footer_parameter_field.value = parameterFieldData.data;
        parameter_footer_field.value = purchaseOrder_footer_parameter_field.value.name;
...
const getPurchaseOrderFooterParameters = async () => {
    ...
    try {
        const footerParameterData = await axios.get(route('purchaseOrder.parameters.footer.get'));
        purchaseOrder_footer_parameters.value = footerParameterData.data;

        await nextTick();
        purchaseOrder_footer_parameters.value.forEach((parameter, index) => {
...
const saveFooterParameter = async () => {
    ...
    try {
        ...
        await axios.post(route('store.purchaseOrder.footer.parameter'), parameter_footer_title.value);
...
const updateFooterParameter = async (id) => {
    ...
    try {
        ...
        await axios.post(route('update.purchaseOrder.footer.parameter'), editFooterParameterData);
...
const confirmDeleteFooterParameter = async () => {
    ...
    try {
        ...
        await axios.delete(route("delete.purchaseOrder.footer.parameter", purchaseOrder_footer_parameter_field.value.id));
...
const saveFooterParameterDescription = async (id, description) => {
    ...
    try {
        ...
        //
        //    const data = document.querySelector(`#quillEditor_${index} .ql-editor`).innerHTML;
        //    const footerParameterData = {
        //        id: id,
        //        description: data,//   };
        //    await axios.post(route('set.purchaseOrder.parameter.footer.description'), footerParameterData);
...
const getCustomField = async (id) => {
    ...
    try {
        ...
        purchaseOrder_parameter_field.value = fieldData.data;
        parameter_field.value = purchaseOrder_parameter_field.value.name;
...
const saveParameter = async () => {
    ...
    try {
        ...
        await axios.post(route('store.purchaseOrder.parameter'), parameter_title.value);
...
const updateParameter = async (id) => {
    ...
    try {
        ...
        await axios.post(route('update.purchaseOrder.parameter'), editParameterData);
...
const confirmDeleteParameter = async () => {
    ...
    try {
        ...
        await axios.delete(route("delete.purchaseOrder.parameter", purchaseOrder_parameter_field.value.id));
...
const saveParameterDescription = async (id, purchaseOrder_parameter) => {

    resetValidationErrors();
    try {

        if (purchaseOrder_parameter.description.length > 120) {
            getPurchaseOrderParameters();
            errorMessage("Description must be less than 120 characters");
        } else {
            const parameterData = {
                id: id,
                description: purchaseOrder_parameter.description,
            };
...
const getPurchaseOrderParameters = async () => {
    ...
    try {
        const parameterData = await axios.get(route('purchaseOrder.parameters.get'));
        purchaseOrder_parameters.value = parameterData.data;
        nextTick(() => {
            loading_bar.value.finish();
        });
    } catch (error) {
...
const getSupplierData = async () => {
    const supplier = (await axios.get(route('supplier.get', select_supplier.value.id))).data;
    selectedSupplierData.value = supplier;
    setSupplierEmailDetails(selectedSupplierData);
};

const setSupplierEmailDetails = async (selectedSupplierData) => {
    try {
        const today = new Date();
        ...
        supplier_email.value.to = selectedSupplierData.value.email;
        ...
        supplier_email.value.message =
            "<p>Hi " + selectedSupplierData.value.name +
...
const sendPurchaseOrderEmail = async () => {
    ...
    try {
        ...
        const response = await axios.post(route("supplier.purchaseOrder.mail.send", purchaseOrder.value.id), supplier_email.value);
...
const getPurchaseOrderSupplier = async () => {
    nextTick(() => {
        loading_bar.value.start();
    });
    try {
        ...
        const tableData = await axios.get(route('purchaseOrder.po.supplier'));
