<template>
    <AppLayout title="Deleted Returns">
        <template #content>
    ...
    <!-- Icon for Empty Deleted Returns State -->
    <div class="text-center col-12 mt-15">
        <i class="text-gray-400 bi bi-trash fs-1"></i>
    </div>

    <!-- Heading for Empty Deleted Returns State -->
    <div class="mt-8 text-center col-12">
        <h2 class="text-gray-700 heading fw-bold fs-2hx">No Deleted Returns</h2>
    </div>

    <!-- Subtext for Empty Deleted Returns State -->
    <div class="mt-2 text-center col-12 mb-15">
        <p class="text-gray-600 fs-5">Deleted returns will appear here.</p>
    </div>
</div>
...
<div class="row"
                                        ...
                                        <table class="table mt-5 align-middle table-hover table-striped fs-6 gy-3">
                                            ...
                                            <tbody class="text-gray-600 fw-semibold">
                                                ...
                                                <tr v-for="(bill, index) in bills" :key="index"
                                                    ...
                                                    <td class="py-2 text-end pe-3" @click.prevent="editReturn(bill.id)">
                                                        {{ bill.formatted_minus_total }}</td>
                                                        <td class="py-2 pe-0 text-end returns-i-icon-col">
        ...
        <table class="table table-bordered table-striped fs-6">
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-end">
                        <span v-if="bill.customer_id == null">Walking Customer</span>
    ...
    <div class="col-sm-6 d-flex justify-content-end align-items-center">
        ...
        <!-- Pagination Controls -->
        <div class="dataTables_paginate paging_simple_numbers" id="kt_ecommerce_bills_table_paginate">
            <ul class="mb-0 pagination">
                <li class="paginate_button page-item previous"
                    :class="pagination.current_page == 1 ? 'disabled' : ''"
                    id="kt_ecommerce_bills_table_previous">
                    <a href="javascript:void(0)" @click="setPage(pagination.current_page - 1)" class="page-link">
                ...
                <template v-for="(page, index) in pagination.last_page">
                    <template v-if="page == 1 || page == pagination.last_page || Math.abs(page - pagination.current_page) < 5">
                        <li class="paginate_button page-item" :key="index" :class="pagination.current_page == page ? 'active' : ''">
                            <a href="javascript:void(0)" @click="setPage(page)" class="page-link">{{ page }}</a>
                        </li>
                    </template>
                </template>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="pt-0 pb-3 mt-0 modal-body">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="py-4 mt-2">
                                        <button @click="allReturnsFilterModalClear"
                                ...
                                <div class="col-6">
                                    <div class="py-4 mt-2 text-right">
                                        <button @click="applyAllReturnsFilter"
                                            class="btn btn-info ms-4 fw-bold">
...
const reload = async () => {
    ...
    const tableData = (
        await axios.get(route('return.deleted.all'), {
            params: {
                page: page.value,
