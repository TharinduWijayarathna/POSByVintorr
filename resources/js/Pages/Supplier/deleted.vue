<template>
    <AppLayout title="Deleted Suppliers">
        <template #content>
                        ...
                        <div class="shadow card pb-15 pb-md-0">
                            <div class="p-3 text-sm card-body p-md-9">
                                ...
                                <div class="row"
                                    ...
                                    <!-- Icon for Empty Deleted Suppliers State -->
                                    <div class="text-center col-12 mt-15">
                                        <i class="text-gray-400 bi bi-archive fs-1"></i>
                                    </div>

                                    <!-- Heading for Empty Deleted Suppliers State -->
                                    <div class="mt-8 text-center col-12">
                                        <h2 class="text-gray-700 heading fw-bold fs-2hx">No Deleted Suppliers</h2>
                                    </div>

                                    <!-- Subtext for Empty Deleted Suppliers State -->
                                    <div class="mt-2 text-center col-12 mb-15">
                                        <p class="text-gray-600 fs-5">Your deleted suppliers will appear here.</p>
                                    </div>
                                </div>
                                ...
                                <div v-if="suppliers.length > 0" class="row">
                                        ...
                                        <table class="table mt-5 align-middle table-hover table-striped fs-6 gy-3">
                                            ...
                                            <tbody class="text-gray-600 fw-semibold">
                                                ...
                                                <tr v-for="supplier in suppliers" class="cursor-pointer">
                                                    <td class="py-2 ps-3">{{
                                                        truncateText(supplier.name) }}</td>
                                                    <td class="py-2 ps-3">{{
                                                        truncateText(supplier.company) }}</td>
                                                    <td class="py-2">{{
                                                        truncateText(supplier.contact) }}</td>
                                                    <td class="py-2">{{
                                                        truncateText(supplier.email) }}</td>
                                                    <td class="py-2 text-end pe-3">
                                                        <div class="d-flex justify-content-end">
                                                            <a href="javascript:void(0)"
                                                                ...
                                                                @click="showRestoreModal(supplier.id)">
                                    ...
                                    <div class="table-responsive d-block d-md-none">
                                        <div v-for="supplier in suppliers" :key="'supplier-table-' + supplier.id"
                                            style="margin-bottom: 20px;">
                                            <!-- Start a new table for each supplier -->
                                            <table class="table table-bordered table-striped fs-6">
                                                <tbody>
                                                    ...
                                                    <!-- Company Name -->
                                                    <tr @click.prevent="viewCustomer(supplier.id)">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-end">
                                                            <a href="javascript:void(0)" data-toggle="tooltip"
                                                                data-placement="bottom" title="Restore supplier"
                                                                @click="showRestoreModal(supplier.id)">
                                ...
                                <!-- Pagination -->
                                <div v-if="suppliers.length > 0" class="my-3 row align-items-center ps-1 ps-md-0">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-info" style="font-weight: bold" data-toggle="tooltip"
                                data-placement="bottom" title="Restore supplier"
                                @click.prevent="restoreSupplier(selectedSupplierId)">
...
function showRestoreModal(supplierId) {
...
// Restore Supplier (Restore Confirmation Modal)
...
const reload = async () => {
    ...
    const tableData = (
        await axios.get(route('supplier.deleted.all'), {
            params: {
                page: page.value,
...
const getSuppliers = async () => {
    ...
    try {
        const tableData = (await axios.get(route('supplier.deleted.all'))).data;
...
const restoreSupplier = async (supplierId) => {
    try {
        ...
        await axios.get(route("supplier.restore", supplierId));
        closeRestoreModal();
