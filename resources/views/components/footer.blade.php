   ...
   <footer class="footer">
                   ...
                   <div class="footer-py-30">
                       <div class="row">
                           ...
                           <div class="col-lg-2 col-md-4 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                               ...
                               <ul class="list-unstyled footer-list mt-4">
                                   <li><a href="#" class="text-foot"><i
                                               class="uil uil-angle-right-b me-1"></i> Home</a></li>
                                   <li><a href="#slider" class="text-foot"><i
                                               class="uil uil-angle-right-b me-1"></i> Suitability</a></li>
                                   <li><a href="#services" class="text-foot"><i
                                               class="uil uil-angle-right-b me-1"></i> Services</a></li>
                                   <li><a href="#faqs" class="text-foot"><i
                                               class="uil uil-angle-right-b me-1"></i> FAQs</a></li>
                                   <li><a href="#contact" class="text-foot"><i
                                               class="uil uil-angle-right-b me-1"></i> Connect</a></li>
                                   <li><a href="{{ route('login') }}" class="text-foot"><i
                           ...
                           <div class="col-lg-3 col-md-4 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                               ...
                               <p class="mt-4">Sign up now to receive the latest and most valuable tips directly in your inbox.</p>
                               <form>
                                   <div class="row">
                                       <div class="col-lg-12">
       ...
       <div class="footer footer-bar" style="padding-top:10px; padding-bottom:10px;">
