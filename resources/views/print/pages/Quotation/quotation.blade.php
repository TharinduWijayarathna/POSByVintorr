...
@section('content')
            ...
            <tbody>
                <tr>
                    <td style="padding-left: 0;">
                        <div class="text-head" style="margin-bottom: 10px; color: {{ $config->color_code }};"><b>QUOTATION
                                - {{ $quotation->code }} </b></div>
                    </td>
                </tr>
                <tr>
                    <td align="left" class="td-customer-style " style="vertical-align:text-top;padding-left: 0;">
                        ...
                        <div style="margin-bottom: 4px;margin-top: 4px;">
                            {{ $quotation->customer_name ? $quotation->customer_name : 'Walking Customer' }}
                        </div>
                        @isset($quotation->customer_mobile)
                            <div style="margin-bottom: 4px;margin-top: 4px;">{{ $quotation->customer_mobile }}</div>
                        @endisset
                        @isset($quotation->customer_email)
                            <div style="margin-bottom: 4px;margin-top: 4px;">{{ $quotation->customer_email }}</div>
                        @endisset
                        @isset($quotation->customer_address)
                            <div style="margin-bottom: 4px;margin-top: 4px;">{{ $quotation->customer_address }}</div>
                        @endisset

                    </td>
                    <td align="right" width="30%" class="td-customer-style customer-section-name" <div>QUOTATION NO<div>
                            {{-- <div style="margin-bottom: 3px;margin-top: 3px;">DATE OF ISSUE</div> --}}
                            <div style="margin-bottom: 3px;margin-top: 3px;">QUOTATION DATE</div>
                    ...
                    <td align="right" width="22%" class="td-customer-style customer-section-description">
                        ...
                        {{-- <div style="margin-bottom: 3px;margin-top: 3px;">
                        {{ \Carbon\Carbon::parse($quotation->due_date)->format('d M, Y') }}
                    </div> --}}
                    </td>
                </tr>
            </tbody>
    ...
    <table cellspacing="0" cellpadding="0" border="0" width="100%" class="quotation_table">
        <thead class="quotation_table_head" style="">
        ...
        <tbody>
            ...
            @if ($quotation->discount > 0)
                ...
                <tr class="row-bg ">
                    ...
                    @endif
                    <td width="10%" class="td-style right-text" style="padding-bottom: 0px; padding-top: 5px;"></td>
                    <td colspan="2" align="right" class="td-style left-text"
                        style="color: #808080;white-space:nowrap; padding-bottom: 2px; padding-top: 5px;">
                        DISCOUNT
                        @if ($quotation->discount_type == 1)
                            ({{ number_format(($quotation->discount / $quotation->sub_total) * 100, 2) }}%)
                        @endif
                    </td>
                    <td class="td-style right-text"
                        style="white-space:nowrap; padding-bottom: 2px; padding-top: 5px;">
                        {{ $quotation->currency_name }}
                ...
                <tr class="row-bg ">
                    ...
                    <td width="10%" class="td-style right-text" style="padding-bottom: 0px; padding-top: 5px;"></td>
                    <td colspan="2" align="right" class="td-style left-text"
                        style="color: #808080;white-space:nowrap;border-bottom: 2px dotted #eee; padding-bottom: 2px; padding-top: 5px;">
                        TOTAL TAX
                    </td>
                    <td class="td-style right-text"
                        style="border-bottom: 2px dotted #eee;white-space:nowrap; padding-bottom: 2px; padding-top: 5px;">
                        {{ $quotation->currency_name }}
                        {{ number_format($quotation->total_tax, 2) }}
                    </td>
                </tr>
            @endif
            @if ($quotation->total_tax > 0 && $quotation->discount <= 0)
                <tr class="row-bg " style="border-top: 2px dotted #eee;">
                    @if ($config->is_line_number == 1)
                        <td class="td-style">
                        </td>
                ...
                <tr class="row-bg "">
                    ...
                    <td width="10%" class="right-text" style="padding-bottom: 0px; padding-top: 5px;"></td>
                    <td colspan="2" align="right" class="td-style left-text"
                        style="color: #808080; padding-bottom: 0px; padding-top: 5px;">TOTAL TAX</td>
                    <td class="td-style right-text" style="white-space:nowrap; padding-bottom: 0px; padding-top: 5px;">
                        {{ $quotation->currency_name }}
                        {{ number_format($quotation->total_tax, 2) }}
                    </td>
            ...
            <tr class="row-bg ">
                ...
                <td width="10%" class="td-style right-text" style="padding-bottom: 0px; padding-top: 5px;"></td>
                <td colspan="2" align="right" class="td-style left-text"
                    style="color: #808080;white-space:nowrap; padding-bottom: 0px; padding-top: 5px; border-top: 2px dotted #eee;">
                    TOTAL</td>
                <td class="td-style right-text"
                    style="padding-bottom: 0px;white-space:nowrap; padding-top: 5px; border-top: 2px dotted #eee;">
                    {{ $quotation->currency_name }}
    ...
    <table cellspacing="0" cellpadding="0" border="0" width="100%">
        <tbody>
            ...
            @foreach ($footer_fields as $footer_field)
                <tr class="row-bg">
                    <div class=""
                        style="opacity: 0.5; white-space: pre-line; text-transform: uppercase; margin-top: 10px; margin-bottom: 5px; font-weight: bold; font-size: 11px;">
                        {{ $footer_field->name }}
                    </div>
    ...
    {{-- <div class="remark-note"><span style="font-size:11px; margin-top:10px; opacity: 0.5;">*This is a computer generated quotation. No
