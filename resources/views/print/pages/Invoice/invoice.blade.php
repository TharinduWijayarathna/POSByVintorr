...
@section('content')
            ...
            <tbody>
                <tr>
                    <td style="padding-left: 0;">
                        <div class="text-head" style="margin-bottom: 10px; color: {{ $config->color_code }};"><b>INVOICE
                                - {{ $order->code }} </b></div>
                    </td>
                </tr>
                <tr>
                    <td align="left" class="td-customer-style " style="vertical-align:text-top;padding-left: 0;">
                        ...
                        <div style="margin-bottom: 4px;margin-top: 4px;">
                            {{ $order->customer ? $order->customer_name : 'Walking Customer' }}
                        </div>
                    ...
                    <td align="right" width="30%" class="td-customer-style customer-section-name">
                        <div>INVOICE NO<div>
                                ...
                                @if ($order->due_date != null)
                                    <div style="margin-bottom: 3px;margin-top: 3px;"><b>DUE DATE</b>
                                    </div>
                                @endif
                    </td>
    ...
    <table cellspacing="0" cellpadding="0" border="0" width="100%" class="invoice_table">
        ...
        <tbody>
                ...
                <tr class="row-bg ">
                    ...
                    <td colspan="2" align="right" class="td-style left-text"
                        ...
                        @if ($order->discount_type == 1)
                            ({{ number_format(($order->discount / $order->sub_total) * 100, 2) }}%)
                        @endif
                    </td>
            ...
            <tr class="row-bg ">
                ...
                <td width="10%" class="td-style right-text" style="padding-bottom: 0px; padding-top: 5px;"></td>
                <td colspan="2" align="right" class="td-style left-text"
                    style="color: #808080;white-space:nowrap; padding-bottom: 0px; padding-top: 5px;">INVOICE TOTAL</td>
                <td class="td-style right-text" style="padding-bottom: 0px;white-space:nowrap; padding-top: 5px;">
                    {{ $order->currency_name }}
            ...
            @if ($order->balance > 0)
                <tr class="row-bg ">
                    ...
                    <td width="10%" class="td-style right-text" style="padding-bottom: 0px; padding-top: 5px;"></td>
                    <td colspan="2" align="right" class="td-style left-text"
                        style="color: #808080;white-space:nowrap; padding-bottom: 0px; padding-top: 5px;">PAID AMOUNT</td>
                    <td class="td-style right-text" style="padding-bottom: 0px;white-space:nowrap; padding-top: 5px;">
                        {{ $order->currency_name }}
                ...
                <tr class="row-bg ">
                    ...
                    <td width="10%" class="td-style right-text" style="padding-bottom: 0px; padding-top: 5px;"></td>
                    <td colspan="2" align="right" class="td-style left-text"
                        style="color: #808080;white-space:nowrap; padding-bottom: 0px; padding-top: 5px;">CHANGE</td>
                    <td class="td-style right-text" style="padding-bottom: 0px;white-space:nowrap; padding-top: 5px;">
                        {{ $order->currency_name }}
            ...
            @else
                ...
                @if ($order->total - $order->customer_paid > 0)
                    <tr class="row-bg ">
                        ...
                        @endif
                        <td width="10%" class="td-style right-text" style="padding-bottom: 0px; padding-top: 5px;">
                        </td>
                        <td colspan="2" align="right" class="td-style left-text"
    ...
    <table cellspacing="0" cellpadding="0" border="0" width="100%">
        <tbody>
            @isset($order->note)
                <tr class="row-bg">
                    <div class="remark-content" style="opacity: 0.5; white-space: nowrap; font-weight: bold;">
                        NOTE
                    </div>
    ...
    {{-- <div class="remark-note"><span style="font-size:11px; opacity: 0.5;">*This is a computer generated invoice. No signature
            required*</span></div> --}}
